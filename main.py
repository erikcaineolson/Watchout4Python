...
class Watchout4Python(App):
    def alpha_to_leet(self, character):
        """
    ...
    def get_phrase(self, word_count):
        """
    ...
    def random_caps(self, any_case, upper_percent_chance=25):
        """
    ...
    def random_characters(self, alpha, numeric_percent_chance=20):
        """
    ...
    def main(self, word_count=2, use_caps=False, use_leet=False, caps_percent=25, leet_percent=20):
        """
